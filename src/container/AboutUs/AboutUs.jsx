  ...
  <div className="app__aboutus app__bg flex__center section__padding" id="about">
    ...
    <div className="app__aboutus-content flex__center">
      <div className="app__aboutus-content_about">
        ...
        <p className="p__opensans">Bienvenidos To AM | PM, A Vibrant Restaurant And Bar. Our Establishment Was Opened In 2021 With The Goal Of Providing Our Customers With A Unique Dining And Nightlife Experience. At AM | PM, We Offer A Display Of Scrumptious Dishes, Custom-Made Cocktails, And Live Entertainment That Will Make You Come Back For More And More...</p>
